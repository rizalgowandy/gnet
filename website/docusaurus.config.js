...
module.exports = {
  ...
  themeConfig: {
    navbar: {
      ...
      links: [
        { to: "https://pkg.go.dev/github.com/panjf2000/gnet?tab=doc", label: "Docs", position: "left" },
        { to: "https://taohuawu.club/", label: "Blog", position: "left" },
        { to: "https://github.com/gnet-io", label: "Community", position: "right" },
        {
      ...
      links: [
        {
          ...
          items: [
            {
              label: "What is Gnet?",
              to: "https://github.com/panjf2000/gnet#-introduction",
            },
            {
              label: "Contact Us",
              to: "contact/",
